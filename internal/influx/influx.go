...
var (
	...
	groupRegexpMap = map[browser.Group]*regexp.Regexp{
		...
		browser.PhotosyntheticallyActiveRadiationTotalIncoming: regexp.MustCompile(`^par_[^dif|soil|dn].*$|par_std`),
		browser.PhotosyntheticallyActiveRadiationTotalOutgoing: regexp.MustCompile(`^par_.*dn_.*$`),
